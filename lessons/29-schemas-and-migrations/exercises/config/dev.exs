...
config :tracker, Tracker.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "tracker_29_exercises_dev",
  stacktrace: true,
...
config :tracker, TrackerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xWxhWblDODMSk7ESmc8LsoLeFuhIfS5TdGwVak5JgTOuw1xSR/W8PObllMal3BEm",
  watchers: [
...
config :tracker, TrackerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tracker_web/router\.ex$"E,
      ~r"lib/tracker_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
